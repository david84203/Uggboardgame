...
export const THEMES = [
  ...
  },
  {
    ...
    name: '摩卡棕',
    emoji: '☕',
    preview: 'linear-gradient(135deg, #FAF7F2, #F5EDE3, #EDE0D4)',
    body: {
      background: `
        radial-gradient(ellipse 80% 60% at 5% 0%, rgba(212, 165, 116, 0.10) 0%, transparent 65%),
        radial-gradient(ellipse 60% 50% at 100% 15%, rgba(192, 144, 96, 0.07) 0%, transparent 60%),
        radial-gradient(ellipse 70% 50% at 45% 100%, rgba(228, 210, 190, 0.12) 0%, transparent 55%),
        linear-gradient(175deg, #FAF7F2 0%, #F7F1E9 55%, #F4EBE0 100%)
      `,
    },
    root: {
      backgroundColor: 'rgba(255, 254, 252, 0.60)',
    },
    ambient: {
      before: 'radial-gradient(circle, rgba(212, 165, 116, 0.45) 0%, transparent 70%)',
      after: 'radial-gradient(circle, rgba(192, 144, 96, 0.35) 0%, transparent 70%)',
    },
    header: {
      background: 'rgba(255, 254, 252, 0.90)',
      borderColor: 'rgba(196, 164, 132, 0.20)',
      titleGradient: 'linear-gradient(to right, #78350F, #92400E)',
      logoShadow: '0 2px 8px rgba(120, 53, 15, 0.12)',
      backBtnText: '#78716C',
      backBtnHoverBg: 'rgba(245, 235, 220, 0.60)',
    },
    card: {
      background: '#FFFFFF',
      border: 'rgba(196, 164, 132, 0.18)',
      hoverBorder: 'rgba(180, 83, 9, 0.22)',
      shadow: '0 1px 2px rgba(120, 53, 15, 0.04), 0 4px 10px rgba(120, 53, 15, 0.04)',
      hoverShadow: '0 4px 16px rgba(146, 64, 14, 0.09), 0 1px 4px rgba(120, 53, 15, 0.05)',
      activeGradient: 'linear-gradient(135deg, #92400E 0%, #78350F 100%)',
      activeShadow: '0 4px 16px rgba(120, 53, 15, 0.20)',
      iconBg: 'rgba(250, 246, 242, 1)',
    ...
    text: {
      ...
      cardDesc: '#8C8480',
      activeText: '#FFFFFF',
      activeDesc: 'rgba(255,255,255,0.85)',
      arrow: '#C8BFB8',
      activeArrow: 'rgba(255,255,255,0.70)',
    },
    scrollbar: '#d6c4b0',
