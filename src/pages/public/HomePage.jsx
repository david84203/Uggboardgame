...
const FACTS = [
  ...
  { label: '外食', value: '可帶外食；整桌共享性餐點（PIZZA、蛋糕等）每桌加收200元清潔費' },
];
...
const SCENES = [
  ...
  { who: '團體／包場', text: '2樓和室可容納約30人，平日整日4,000元、假日整日6,000元，整段時段計價不另計人數。' },
];
...
const FAQ_PREVIEW = [
  ...
  { q: '可以帶外食嗎？', a: '可以，個人餐點與飲料不另收費。整桌共享性餐點每桌加收200元清潔費（依放置餐點的桌子計算）。店內也有泡麵、米漢堡、炸物拼盤、飲料與零食（供餐至21:00）。' },
