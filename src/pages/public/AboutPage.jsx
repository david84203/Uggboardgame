    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-5">
        <section className="bg-white border border-stone-200 rounded-2xl p-4 shadow-sm">
          <h1 className="text-xl font-bold text-stone-800 mb-2">烏嘎嘎桌遊</h1>
        ...
        <section className="bg-white border border-stone-200 rounded-2xl overflow-hidden shadow-sm">
          ...
          <div className="p-4 space-y-3 text-stone-600 text-base leading-relaxed">
        ...
        <section className="bg-white border border-stone-200 rounded-2xl overflow-hidden shadow-sm">
          ...
          <ul className="divide-y divide-stone-100">
            {FLOORS.map((f) => (
              <li key={f.floor} className="px-4 py-3">
        ...
        <section className="bg-pink-50 border border-pink-200 rounded-2xl p-4">
          <p className="text-stone-700 text-base leading-relaxed">
