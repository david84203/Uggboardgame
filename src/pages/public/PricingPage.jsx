    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-10 space-y-8">
        <section className="bg-white border border-stone-200 rounded-2xl p-5 sm:p-6 shadow-sm">
          <h1 className="text-2xl font-bold text-stone-800 mb-3">服務與收費</h1>
        ...
        <section className="bg-white border border-stone-200 rounded-2xl overflow-hidden shadow-sm">
          ...
          <div className="p-5 sm:p-6 text-stone-600 text-base leading-relaxed space-y-2">
        ...
        {/* 遊戲教學 */}
        <section className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 sm:p-6">
              ...
              <table className="w-full text-sm mt-2 border-collapse">
                <thead>
                  <tr className="bg-stone-100 text-stone-500 text-left">
                    <th className="py-2 px-3 font-medium rounded-l-lg">時段</th>
                    <th className="py-2 px-3 font-medium text-right">平日</th>
                    <th className="py-2 px-3 font-medium text-right rounded-r-lg">假日</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-stone-100">
                  <tr>
                    <td className="py-2.5 px-3">13:00–18:00</td>
                    <td className="py-2.5 px-3 text-right font-bold tabular-nums">3,000元</td>
                    <td className="py-2.5 px-3 text-right font-bold tabular-nums">4,000元</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-3">18:00–24:00</td>
                    <td className="py-2.5 px-3 text-right font-bold tabular-nums">3,500元</td>
                    <td className="py-2.5 px-3 text-right font-bold tabular-nums">4,000元</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-3">整日</td>
                    <td className="py-2.5 px-3 text-right font-bold tabular-nums">4,000元</td>
                    <td className="py-2.5 px-3 text-right font-bold tabular-nums">6,000元</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        {/* 租借遊戲 */}
        <section className="bg-white border border-stone-200 rounded-2xl overflow-hidden shadow-sm">
          <div className="bg-amber-600 px-5 sm:px-6 py-3">
            <h2 className="font-bold text-white text-base">📦 桌遊租借（限會員）</h2>
          </div>
          <div className="p-5 sm:p-6 space-y-2 text-stone-600 text-base leading-relaxed">
